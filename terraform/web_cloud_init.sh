...
docker run --rm --name "hugo" -v $(pwd)/src:/src -v $(pwd)/output:/output -e HUGO_BASEURL="http://jhnr-blog-prod.westeurope.cloudapp.azure.com/" -e HUGO_THEME="hyde" jojomi/hugo
